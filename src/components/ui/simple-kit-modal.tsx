...
const SimpleKitModalContent = ({
  ...
  return (
    <SimpleKitModalContent
      className={cn(
        "rounded-t-3xl sm:rounded-3xl md:max-w-[480px] [&>button]:right-[26px] [&>button]:top-[26px]",
        className,
      )}
...
const SimpleKitModalBody = ({
  ...
  return (
    <ScrollArea
      className={cn(
        "h-[300px] max-h-[350px] px-6 md:-mr-4 md:h-full md:max-h-[350px] md:px-0 md:pr-4",
        className,
      )}
      {...props}
    >
